/* Copyright 2015-2020 Melody Willow
 *
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Shift |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | ALTGR| MACRO| LAlt | LGUI |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
[_QWERTY] = LAYOUT_preonic_grid_wrapper( \
  ...
  KC_ALGR, MACROL,  KC_LALT, KC_LGUI,  LOWER,    NAV_S,   NAV_S,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT  \
),
[_MACROS] = LAYOUT_preonic_grid_wrapper( \
  _______, __________________BASE_L0__________________, __________________BASE_R0__________________, _______, \
  _______, HEHE,    SWAVE,   EYES,    SHRUG,   WAVEB,   EYESL,   WHAT,    HAPPY,   _______, _______, _______,  \
 ...
 * |   ~  |   !  |   @  |   #  |   $  |   %  |   ^  |   &  |   *  |   (  |   )  | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Del  |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  |  F0  |  '   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |   -  |  _   |  =   |   +  |   |  |   \  |   [  |   ]  |   {  |   }  |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Back | Pause| Next |      |
 ...
 * |   ~  |      |  INS |      | PSCR |      |      |      |      |      |      | Del  |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Del  |      | Home | Pgup | Pgdn |  End | Left |  Up  | Down | Rght |      | CAD  |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      | Undo | Cut  | Copy | Paste|      |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Back | Pause| Next |      |             |      | Mute | Vol- | Vol+ |      |
 * `-----------------------------------------------------------------------------------'
 */
 ...
 * |      | Reset| Debug|      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Caps |      |      |      |      |AGnorm|AGswap|Qwerty|GAMING|      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
